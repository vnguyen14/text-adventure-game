    ...
    for riddle in riddles:
        while True:
            ...
            if answer in riddle["answers"]:
                ...
                collected_items.append(riddle["answers"][0])  # Add solved riddle items to collected
                break
            else:
...
def take_item(item_name, room, items):
...
def process_bakery_command(command, room, items):
    ...
    if action == "talk" and item_name == "to jeremy":
        ...
        take_item(item_name, room, items)
    else:
